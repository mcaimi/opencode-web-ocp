...
ARG SEMGREP_SKILL_REPO=https://github.com/semgrep/skills
...
RUN set -eux; \
  mkdir -p /opt/semgrep-skills; \
  git clone ${SEMGREP_SKILL_REPO} /opt/semgrep-skills && chgrp -R 0 /opt/semgrep-skills && chmod -R g=u /opt/semgrep-skills; \
